  ...
  return (
    <div className="about">
      ...
      <p className="message">
        ...
        with multiple teams within the company to deliver a complete product in
        a timely manner to satisfy everyone and most importantly the client. As
        a Software Engineer, I will use my background to find solutions that
        will benefit the company and its end-users.
        </p>
